...
def payment_card_user_info(payment_transaction: models.PaymentTransaction, *, session: db.Session) -> dict:
...
def persist_user_identity(
    payment_transaction: models.PaymentTransaction, user_info: dict, *, session: db.Session
) -> models.UserIdentity:
