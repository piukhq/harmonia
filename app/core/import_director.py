...
class PaymentImportDirector(ImportDirector):
    def handle_payment_transaction(
        self, payment_transaction: models.PaymentTransaction
    ) -> None:
        status_monitor.checkin(self)
        ...
        log.info(
            f"Received, persisted, and enqueued payment transaction #{payment_transaction}."
        )
