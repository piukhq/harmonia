...
import_agents.add("harvey-nichols", "app.imports.agents.harvey_nichols.HarveyNicholsAgent")
import_agents.add("iceland-bonus-card", "app.imports.agents.iceland.IcelandAgent")

import_agents.add("example-active-agent", "app.imports.agents.example_active.ExampleActiveAgent")
