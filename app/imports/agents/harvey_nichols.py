...
class HarveyNicholsAgentTransactionSchema(Schema):
...
class HarveyNicholsAgent(DirectoryWatchAgent):
    schema = HarveyNicholsAgentTransactionSchema()
    ...
    def help(self) -> str:
        return inspect.cleandoc(
            f"""
            This is the Harvey Nichols payment transaction file import agent.
