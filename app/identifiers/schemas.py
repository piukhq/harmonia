...
class IdentifierCreationSchema(Schema):
    ...
    loyalty_plan = fields.String(required=True, validate=[NotBlank, validate.Regexp("^[a-z0-9]+(?:-[a-z0-9]+)*$")])
    payment_scheme = fields.String(required=True, validate=[NotBlank, validate.Regexp("^[a-z0-9]+(?:-[a-z0-9]+)*$")])
