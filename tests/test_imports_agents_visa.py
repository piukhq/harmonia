...
auth_tx_data = {
    ...
    "MessageElementsCollection": [
        ...
        {"Key": "Transaction.MerchantCardAcceptorId", "Value": primary},
        ...
        {"Key": "Transaction.VisaMerchantId", "Value": psimi},
        {"Key": "Transaction.VisaStoreName", "Value": "Bink Shop"},
        {"Key": "Transaction.VisaStoreId", "Value": secondary},
...
refund_tx_data = {
    ...
    "MessageElementsCollection": [
        ...
        {"Key": "ReturnTransaction.CardAcceptorIdCode", "Value": primary},
        ...
        {"Key": "ReturnTransaction.VisaMerchantId", "Value": psimi},
        {"Key": "ReturnTransaction.VisaStoreName", "Value": "Bink Shop"},
        {"Key": "ReturnTransaction.VisaStoreId", "Value": secondary},
...
@pytest.mark.parametrize(
    "input, expected",
    [
        ([primary, secondary, psimi], [primary, secondary, psimi]),
        ([primary, secondary, ""], [primary, secondary]),
        ([primary, secondary, "0"], [primary, secondary]),
...
def test_auth_get_mids():
    ...
    assert ids == [primary, secondary, psimi]
