...
def upgrade():
    op.create_table(
        'import_transaction', sa.Column('id', sa.Integer(), nullable=False),
        sa.Column(
        ...
        sa.Column('source', sa.String(length=500), nullable=True), sa.Column('data', sa.JSON(), nullable=True),
        sa.PrimaryKeyConstraint('id'), sa.UniqueConstraint('provider_slug', 'transaction_id', name='_slug_tid_uc'))
    op.create_table(
        'loyalty_scheme', sa.Column('id', sa.Integer(), nullable=False),
        sa.Column(
            'created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True), sa.Column('slug', sa.String(length=50), nullable=False),
        sa.PrimaryKeyConstraint('id'))
    op.create_table(
        'payment_provider', sa.Column('id', sa.Integer(), nullable=False),
        sa.Column(
            'created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True), sa.Column('slug', sa.String(length=50), nullable=False),
        sa.PrimaryKeyConstraint('id'))
    op.create_table(
        'merchant_identifier', sa.Column('id', sa.Integer(), nullable=False),
        sa.Column(
            'created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True), sa.Column('mid', sa.String(length=50), nullable=False),
    ...
    op.create_table(
        'matched_transaction', sa.Column('id', sa.Integer(), nullable=False),
        sa.Column(
            'created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        ...
        sa.Column(
            'matching_type', sa.Enum('SPOTTED', 'LOYALTY', 'NON_LOYALTY', 'MIXED', name='matchingtype'),
            nullable=False), sa.Column('extra_fields', sa.JSON(), nullable=True),
        sa.ForeignKeyConstraint(
            ['merchant_identifier_id'],
            ['merchant_identifier.id'],
        ), sa.PrimaryKeyConstraint('id'))
    op.create_table(
        'payment_transaction', sa.Column('id', sa.Integer(), nullable=False),
        sa.Column(
            'created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.Column('merchant_identifier_id', sa.Integer(), nullable=True),
    ...
    op.create_table(
        'scheme_transaction', sa.Column('id', sa.Integer(), nullable=False),
        sa.Column(
            'created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.Column('merchant_identifier_id', sa.Integer(), nullable=True),
